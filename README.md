...
## Introduction
LibDeflate is a DEFLATE/zlib compressors and decompressors, which compress
...
## Install
[LibDeflate.lua](LibDeflate.lua) is the only file of LibDeflate. Copy the file
to your LUA_PATH to install it.


## Usage
See [example](examples/example.lua)
